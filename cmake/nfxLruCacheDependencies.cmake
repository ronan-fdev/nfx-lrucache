...
set(NFX_LRUCACHE_GTEST_MIN_VERSION          "1.12.1")
set(NFX_LRUCACHE_BENCHMARK_MIN_VERSION      "1.9.4" )
...
if(NFX_LRUCACHE_BUILD_TESTS)
	find_package(GTest ${NFX_LRUCACHE_GTEST_MIN_VERSION} QUIET)
...
# --- Google benchmark ---
if(NFX_LRUCACHE_BUILD_BENCHMARKS)
	find_package(benchmark ${NFX_LRUCACHE_BENCHMARK_MIN_VERSION} QUIET)
