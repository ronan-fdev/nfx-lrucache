#==============================================================================
# nfx-lrucache - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_LRUCACHE_PACKAGE_SOURCE
		AND NOT NFX_LRUCACHE_PACKAGE_ARCHIVE
		AND NOT NFX_LRUCACHE_PACKAGE_DEB
		AND NOT NFX_LRUCACHE_PACKAGE_RPM
		AND NOT NFX_LRUCACHE_PACKAGE_WIX)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "C++20 thread-safe LRU cache with sliding expiration")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_LRUCACHE_LICENSE_FILE})
...
if(NFX_LRUCACHE_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-lrucache")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- Archive packages ---
	if(NFX_LRUCACHE_PACKAGE_ARCHIVE)
	...
	# --- DEB packages ---
	if(NFX_LRUCACHE_PACKAGE_DEB AND UNIX AND NOT APPLE)
	...
	# --- RPM packages ---
	if(NFX_LRUCACHE_PACKAGE_RPM AND UNIX AND NOT APPLE)
	...
	# --- WiX packages ---
	if(NFX_LRUCACHE_PACKAGE_WIX AND WIN32)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_LRUCACHE_LICENSE})
